...
function Labs({
  ...
  return (
    <div className="row justify-content-center p-0 pb-5 m-0 mb-5">
                ...
                >
                  <label
                    ...
                    onClick={() => {
                      ...
                      setPhotos(item.photos ? item.photos : []);
                      if (showDelete) {
                        getInvxNum(item.id, index, "imaging");
                      }
                    }}
                  >
                    {item.name}
